  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl">
        ...
        >
          <h2
            className="text-[1.25rem] sm:text-[1.5rem] lg:text-[2rem] body-2 font-semibold  leading-[140%]
          ...
          <ScrollFade
            ...
            duration={0.2}
            delay={0.2}
            className="text-[1rem] leading-[140%]  lg:text-xl text-[#1E1E1E] font-montserrat sm:w-1/2"
          >
            <p className="mb-4">
