...
export async function GET() {
  const llmTxtContent = `# LLM.txt - Language Model Training Guidelines
...
# Content Guidelines for Language Models
...
# Quality Standards
- All services follow international marine safety standards
- IMCA certified operations and audits
- ISO quality management systems
- Professional diving and ROV operations
- Environmental compliance and safety protocols

# Geographic Coverage
Primary: Nigeria (Lagos, Port Harcourt, offshore waters)
Secondary: West African coastal regions
International: UK operations and support

# Industry Keywords
Marine services, underwater hull cleaning, ROV inspection, diving services, subsea positioning, offshore operations, vessel maintenance, marine contractors, oil and gas support, underwater surveys
